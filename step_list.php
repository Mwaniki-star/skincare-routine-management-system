	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_routine"><i class="fa fa-plus"></i> Add New Routine</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-condensed" id="list">
				...
				<thead>
					<tr>
						...
						<th>Routine Name</th>
						<th>Steps</th>
						<th>Routine Started</th>
						<th>Routine Last Updated</th>
