...
<div class="col-lg-12">
			...
			<div class="callout callout-info">
				<div class="col-md-12">
					<div class="row">
						<div class="col-sm-6">
							<dl>
								<dt><b class="border-bottom border-primary">Routine's Name</b></dt>
						...
						<div class="col-md-6">
							<dl>
								<dt><b class="border-bottom border-primary">Routine Start Date</b></dt>
								<dd><?php echo date("F d, Y",strtotime($start_date)) ?></dd>
							</dl>
							<dl>
								<dt><b class="border-bottom border-primary">Last Updated</b></dt>
							...
							<dl>
								<dt><b class="border-bottom border-primary">Routine Manager</b></dt>
								<dd>
	...
	<div class="row">
		<div class="col-md-4">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<span><b>SkinCare Products:</b></span>
		...
		<div class="col-md-8">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<span><b>Routine Steps List:</b></span>
					<?php if($_SESSION['login_type'] != 3): ?>
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_task"><i class="fa fa-plus"></i> New Routine Step</button>
					</div>
				<?php endif; ?>
				</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>Routine Activity/Logs</b>
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_productivity"><i class="fa fa-plus"></i> New Observation</button>
					</div>
				</div>
				<div class="card-body">
					<?php 
						...
						<div class="post">
		                      ...
		                      <div class="user-block">
		                        ...
		                        <span class="description">
		                        	...
		                        	<span> | </span>
                      				<span>Last updated: <b><?php echo date('h:i A',strtotime($row['date'].' '.$row['end_time'])) ?></b></span>
	                        	</span>
